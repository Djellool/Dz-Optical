...
import 'FifthLevel.dart';
import 'LentilleDetails.dart';

class FourthLevel extends StatefulWidget {
  @override
  _FourthLevelState createState() => _FourthLevelState();
}

class _FourthLevelState extends State<FourthLevel>
  ...
  Widget build(BuildContext context) {
    print("level 4");
    print("Path = " + controller.path.toString());
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: FutureBuilder(
            future: Future.wait([
              DBProvider.db.getAllLentillesfourthlevel(
              ...
              DBProvider.db.getLentilleNiveau3(
                  controller.path[0], controller.path[1], controller.path[2])
            ]),
