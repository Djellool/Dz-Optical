import 'dart:async';
import 'dart:io';
import 'package:eos/views/screens/Verres/ThirdLevel.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
            future: Future.wait([
              DBProvider.db.getAllVerresSecondLevel(controller.path[0]),
              DBProvider.db.getAllTraitementsavecVerres(),
              DBProvider.db.getVerreNiveau1(controller.path[0]),
            ]),
